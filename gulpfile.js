...
gulp.task("css-other", function () {
  return gulp.src("source/scss/other.scss")
    .pipe(plumber())
    .pipe(saas())
    .pipe(postcss([
      autoprefixer()
...
gulp.task("style-other", function (done) {
  gulp.src("source/scss/other.scss")
    .pipe(plumber())
    .pipe(saas())
    .pipe(postcss([
      autoprefixer()
...
gulp.task('build', gulp.series('clean', 'style-main', 'style-other', 'images', 'copy', "del-vendor-folder", "js", function (done) {
  done();
}));

gulp.task("start", gulp.series("fileinclude", "css-main", "css-other", "copy", "js", "server"));
